...
import PurchaseProductWiseChart from "./purchaseProductWiseChart";
import ChartDrawer from './chartDrawer';
import { useSelector } from 'react-redux';
import { jwtDecode } from 'jwt-decode';

const PurchaseProductWiseGraphView = () => {
	...
	return (
		<Box>
			...
			<PurchaseProductWiseChart />
		</Box>
	);
};

export default PurchaseProductWiseGraphView;
