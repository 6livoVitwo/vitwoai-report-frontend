...
import ProductionOrderTrackingChart from "./productionOrderTrackingChart";
import ChartDrawer from './chartDrawer';
import { useSelector } from 'react-redux';
import { jwtDecode } from 'jwt-decode';

const ProductionOrderTrackingGraphView = () => {
  ...
  return (
    <Box>
      ...
      <ProductionOrderTrackingChart />
    </Box>
  );
};

export default ProductionOrderTrackingGraphView;
