...
import SalesVerticalWiseChart from './salesVerticalWiseChart';
import ChartDrawer from './chartDrawer';
import { useSelector } from 'react-redux';
import { jwtDecode } from 'jwt-decode';

const SalesVerticalWiseGraphView = () => {
  ...
  return (
    <Box>
      ...
      <SalesVerticalWiseChart />
    </Box>
  );
};

export default SalesVerticalWiseGraphView;
