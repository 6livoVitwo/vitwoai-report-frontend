...
import InventoryAgeingReceivedDateChart from "./inventoryAgeingReceivedDateChart";
import ChartDrawer from './chartDrawer';
import { useSelector } from 'react-redux';
import { jwtDecode } from 'jwt-decode';

const InventoryAgeingReceivedDateGraphView = () => {
  ...
  return (
    <Box>
      ...
      <InventoryAgeingReceivedDateChart />
    </Box>
  );
};

export default InventoryAgeingReceivedDateGraphView;
