...
import InventoryAgeingIssueDateChart from "./inventoryAgeingIssueDateChart";
import ChartDrawer from './chartDrawer';
import { useSelector } from 'react-redux';
import { jwtDecode } from 'jwt-decode';

const InventoryAgeingIssueDateGraphView = () => {
  ...
  return (
    <Box>
      ...
      <InventoryAgeingIssueDateChart />
    </Box>
  );
};

export default InventoryAgeingIssueDateGraphView;
