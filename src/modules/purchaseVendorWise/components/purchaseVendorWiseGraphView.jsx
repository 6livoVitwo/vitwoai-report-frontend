...
import PurchaseVendorWiseChart from "./purchaseVendorWiseChart";
import ChartDrawer from './chartDrawer';
import { useSelector } from 'react-redux';
import { jwtDecode } from 'jwt-decode';

const PurchaseVendorWiseGraphView = () => {
	...
	return (
		<Box>
			...
			<PurchaseVendorWiseChart />
		</Box>
	);
};

export default PurchaseVendorWiseGraphView;
