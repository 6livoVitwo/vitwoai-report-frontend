        ...
        <DrawerContent
          ...
          <DrawerBody>
            <Box
              ...
              Total Graph ({chartsData.charts.filter((chart) => chart.type !== "bar" && chart.type !== "funnel" && chart.type !== "pie").length})
            </Box>
            <Box display="flex" flexWrap="wrap" justifyContent="space-between">
              {chartsData.charts.map((chart, index) => {
                if (chart.type === "bar" || chart.type === "funnel" || chart.type === "pie") return null;
                return (
                  <Box
                    key={index}
                    width={{
