...
const PurchaseDetailedCustomTable = ({ setPage, newArray, setDateRange }) => {
    ...
    <Box bg="white" padding="0px 10px" borderRadius="5px">
      ...
      <Modal isOpen={isOpen} onClose={handleModalClose} size="xl" isCentered>
        ...
        <ModalContent minW="40%" maxH="90vh" overflow="hidden">
          <ModalHeader
            fontWeight="600"
            bg="mainBlue"
            color="white"
...
export default PurchaseDetailedCustomTable;
