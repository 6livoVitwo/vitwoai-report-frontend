...
const MainBodyDrawer = (props) => {
    ...
    const filteredCharts = useMemo(() => {
        return checkWidgets?.filter((chart) => {
            return (
                chart.selectedWise === selectedWise &&
                chart.reportType === reportType &&
                chart.companyId === companyId &&
                chart.branchId === branchId &&
                chart.locationId === locationId &&
                chart.userId === userId
            );
        });
    ...
    const chartData = useMemo(() => {
        if (!filteredCharts || filteredCharts.length === 0) return null;
